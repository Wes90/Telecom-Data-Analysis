function initViz() {
  ...
  url3= "https://public.tableau.com/views/Book1_16166499785510/Dashboard3?:language=en&:display_count=y&publish=yes&:origin=viz_share_link",
  options = {
      hideToolbar: true,
      width: "1300px",
      height: "1050px",
  };
  viz2 = new tableau.Viz(stackchart, url3, options);
}
